...
/**
 * A builder for {@link org.apache.lucene.util.BytesRef} instances.
 * @lucene.internal
 */
public class BytesRefBuilder {
  ...
  /**
   * Replace the content of this builder with the provided bytes. Equivalent to
   * calling {@link #clear()} and then {@link #append(org.apache.lucene.util.BytesRef)}.
   */
  ...
  /**
   * Replace the content of this builder with the provided bytes. Equivalent to
   * calling {@link #clear()} and then {@link #append(org.apache.lucene.util.BytesRefBuilder)}.
   */
  ...
  /**
   * Return a {@link org.apache.lucene.util.BytesRef} that points to the internal content of this
  ...
  /**
   * Build a new {@link org.apache.lucene.util.BytesRef} that has the same content as this buffer.
   */
