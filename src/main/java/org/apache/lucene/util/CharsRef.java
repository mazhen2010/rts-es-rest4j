...
public final class CharsRef implements Comparable<CharsRef>, CharSequence, Cloneable {
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.CharsRef} initialized an empty array zero-length
   */
  public CharsRef() {
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.CharsRef} initialized with an array of the given
   * capacity
   */
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.CharsRef} initialized with the given array, offset and
   * length
   */
  ...
  /**
   * Creates a new {@link org.apache.lucene.util.CharsRef} initialized with the given Strings character
   * array
   */
  ...
  /**
   * Copies the given {@link org.apache.lucene.util.CharsRef} referenced content into this instance.
   * 
   * @param other
   *          the {@link org.apache.lucene.util.CharsRef} to copy
   * @deprecated {@link org.apache.lucene.util.CharsRef} should not be used as a buffer, use {@link org.apache.lucene.util.CharsRefBuilder} instead
   */
  @Deprecated
