...
public final class ArrayUtil {
  ...
  */
  ...
  /** Get the natural {@link java.util.Comparator} for the provided object class. */
  ...
  /**
   * Sorts the given array slice using the {@link java.util.Comparator}. This method uses the intro sort
  ...
  /**
   * Sorts the given array using the {@link java.util.Comparator}. This method uses the intro sort
   * algorithm, but falls back to insertion sort for small arrays.
   */
  ...
  /**
   * Sorts the given array slice using the {@link java.util.Comparator}. This method uses the Tim sort
  ...
  /**
   * Sorts the given array using the {@link java.util.Comparator}. This method uses the Tim sort
   * algorithm, but falls back to binary sort for small arrays.
   */
