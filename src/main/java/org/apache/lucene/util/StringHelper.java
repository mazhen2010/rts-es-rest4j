...
public abstract class StringHelper {
  ...
  /**
   * Compares two {@link org.apache.lucene.util.BytesRef}, element by element, and returns the
   * number of elements common to both arrays.
   *
   * @param left The first {@link org.apache.lucene.util.BytesRef} to compare
   * @param right The second {@link org.apache.lucene.util.BytesRef} to compare
   ...
   * so that {@link org.apache.lucene.util.BytesRef#compareTo(org.apache.lucene.util.BytesRef)} still returns the same result.
   ...
   * 
   * @param ref
   *          the {@link org.apache.lucene.util.BytesRef} to test
   * @param prefix
   *          the expected prefix
   * @return Returns <code>true</code> iff the ref starts with the given prefix.
   *         Otherwise <code>false</code>.
