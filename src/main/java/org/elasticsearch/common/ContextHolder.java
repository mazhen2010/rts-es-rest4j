...
public class ContextHolder {
    ...
    public final synchronized <V> V putInContext(Object key, Object value) {
        if (context == null) {
            context = new ObjectObjectOpenHashMap<Object, Object>(2);
        }
    ...
    public final synchronized void putAllInContext(ObjectObjectAssociativeContainer<Object, Object> map) {
        ...
        if (context == null) {
            context = new ObjectObjectOpenHashMap<Object, Object>(map);
        } else {
            context.putAll(map);
        }
    }
    ...
    public synchronized void copyContextFrom(ContextHolder other) {
        synchronized (other) {
            ...
            if (context == null) {
                context = new ObjectObjectOpenHashMap<Object, Object>(other.context);
            } else {
