...
public abstract class ShapeBuilder implements ToXContent {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(ShapeBuilder.class);
     ...
     * @throws java.io.IOException if the input could not be read
     */
    ...
    public static Orientation orientationFromString(String orientation) {
        ...
        if ("ccw".equals(orientation)) {
            return Orientation.RIGHT;
        } else if ("cw".equals(orientation)) {
...
//        }
    ...
    public static enum GeoShapeType {
        ...
        public static ShapeBuilder parse(XContentParser parser, GeoShapeFieldMapper shapeMapper) throws IOException {
            ...
            Orientation requestedOrientation = (shapeMapper == null) ? Orientation.RIGHT : Orientation.LEFT;
         ...
         * @throws java.io.IOException Thrown if an error occurs while reading from the XContentParser
         */
