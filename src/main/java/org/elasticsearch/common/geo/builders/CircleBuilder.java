...
public class CircleBuilder extends ShapeBuilder {
    ...
    /**
     * Set the radius of the circle. The String value will be parsed by {@link org.elasticsearch.common.unit.DistanceUnit}
     ...
     * @param unit unit name of the radius value (see {@link org.elasticsearch.common.unit.DistanceUnit})
     * @return this
     */
     ...
     * Set the radius of the circle
     * @param radius value of the circles radius
     * @param unit unit of the radius value (see {@link org.elasticsearch.common.unit.DistanceUnit})
     * @return this
     */
