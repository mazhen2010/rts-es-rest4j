...
public class GeometryCollectionBuilder extends ShapeBuilder {
    ...
    protected final ArrayList<ShapeBuilder> shapes = new ArrayList<ShapeBuilder>();
    ...
    public Shape build() {
        ...
        List<Shape> shapes = new ArrayList<Shape>(this.shapes.size());
        ...
        if (shapes.size() == 1)
            ...
            return new XShapeCollection<Shape>(shapes, SPATIAL_CONTEXT);
